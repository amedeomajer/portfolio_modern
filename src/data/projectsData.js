const projectsData = [
  ...
  {
    name: 'Sorting hat',
    placeholderDescription: ' is a fun website used to run the sorting ceremony for the new students in their coalition. This is part of the gamified experience that students experience in Hive Helsinki.',
    longDescription: 'Hire a Hiver is a platform that connects businesses with talented students from Hive Helsinki. The platform is built with Ruby on Rails and uses Sidekiq for background jobs. The front-end is built with haml and Tailwind CSS. The platform uses Redis for caching and Postgresql for the database.',
