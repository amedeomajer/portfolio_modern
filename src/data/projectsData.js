const projectsData = [
  ...
  },
  {
    name: "Hire a Hiver",
    placeholderDescription:
      "A platform that connects businesses with talented students from Hive Helsinki.",
    longDescription: {
      intro:
  ...
  },
  {
    name: "Tech report",
    placeholderDescription:
      "Ticketing system for hardware issues in Hive Helsinki campus.",
    longDescription: {
      intro:
  ...
  },
  {
    name: "Sorting hat",
    placeholderDescription:
      "Fun website used to run the sorting ceremony for the new Hive students in their coalition. This is part of the gamified experience that students experience in Hive Helsinki.",
    longDescription: {
      intro:
