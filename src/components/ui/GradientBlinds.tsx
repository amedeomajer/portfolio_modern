...
const prepStops = (
  stops?: string[]
): { arr: [number, number, number][]; count: number } => {
...
const GradientBlinds = ({
  ...
  // Initialize to center of viewport to avoid animation from corner
...
`;
    ...
    // Initialize mouse at center to avoid animation from corner
    ...
    // Listen on window instead of canvas so it works even when content is on top
